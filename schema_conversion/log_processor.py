...
class LogProcessor:
    ...
    def process_single_log(
        ...
        if getattr(self, "no_llm", False):
            ...
            _TYPE_MAP = {
                "power_failure": "hardware", "fan_failure": "hardware", "fan_nominal": "hardware", "thermal": "hardware", "linecard_disabled": "hardware",
                "crc_errors": "physical_link", "interface_down": "physical_link",
                "interface_up": "physical_link", "transceiver": "physical_link",
                "stp_topology_change": "topology", "stp_converged": "topology",
                "lldp_neighbor_removed": "topology", "lldp_neighbor_discovered": "topology",
                "ospf": "routing", "bgp": "routing",
                "ospf_interface_down": "routing", "ospf_interface_up": "routing", "ospf_neighbor_down": "routing", "ospf_neighbor_up": "routing",
                "route_recalculation_started": "routing",
                "route_recalculation_completed": "routing",
                "bgp_session_lost": "routing",
                "bgp_session_established": "routing",
                "route_withdrawal": "routing",
                "routes_withdrawn": "routing",
                "routes_relearned": "routing",
                "dot1x_failure": "access_control", "mac_auth": "access_control", "port_blocked": "access_control",
                "dot1x_success": "access_control", "dot1x_logout": "access_control",
                "radius_failure": "security", "radius_recovered": "security",
                "ssh_bruteforce": "security", "admin_auth_failure": "security", "ssh_source_blocked": "security",
                ...
                "vrrp_state_change": "high_availability", "hsrp_state_change": "high_availability",
                "mlag_peer_down": "high_availability",
                "acl_deny": "security", "arp_spoofing": "security", "mac_flap": "security",
                "ipsec_tunnel_down": "vpn", "ike_failure": "vpn",
                "pim_neighbor_down": "multicast", "igmp_snooping_error": "multicast",
            }
